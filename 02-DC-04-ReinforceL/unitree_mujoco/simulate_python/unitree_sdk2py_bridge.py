                    ...
                    "".join(
                        [
                            ...
                            for key in [
                                0,
                                0,
                                int(self.joystick.get_button(self.axis_id["LT"]) > 0),
                                int(self.joystick.get_button(self.axis_id["RT"]) > 0),
    ...
    def PublishWirelessController(self):
        if self.joystick != None:
            ...
            key_state[self.key_map["R2"]] = (
                self.joystick.get_button(self.axis_id["RT"]) > 0
            )
            key_state[self.key_map["L2"]] = (
                self.joystick.get_button(self.axis_id["LT"]) > 0
            )
